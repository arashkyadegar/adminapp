...
import { getCategoriesAction, getCategoriesTreeAction, getCategoryAction, submitAddCategoryAction, submitEditCategoryAction } from "../../redux/store/category/category-action";
     ...
     function submit(event: any) {
          ...
          if (categoryFormState.data.formIsValid) {
               ...
               try {
                    ...
                    dispatch(submitEditCategoryAction(entity));
               } catch (err) {
                    console.log("rrrr");
               }
          } else {
