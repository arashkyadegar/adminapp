...
export default function PcSidebarComponent() {
  ...
  "
                         >
                              <li onClick={() => navigate("/image/image-add")} className="px-3 py-1 hover:bg-gray-100 cursor-pointer"> تصویر جدید</li>
                              <li onClick={() => navigate("/image/image-list")} className="px-3 py-1 hover:bg-gray-100 cursor-pointer">لیست  تصاویر</li>
                         </ul>
                    </li>
                    {/* دسته بندی ها */}
                    <li className=" relative mx-auto rounded-md  hover:border  border-gray-200  text-gray-500 duration-150 flex-col  m-2 h-10 items-center justify-center">
                    ...
                    <li className=" relative mx-auto rounded-md  hover:border  border-gray-200  text-gray-500 duration-150 flex-col  m-2 h-10 items-center justify-cente">
                         ...
                         <ul
                              ...
                              className="bg-white border rounded-sm absolute top-0 right-52
                                        ...
                                        min-w-32">
                              <li
                                   onClick={() => navigate("/ticket/ticket-add")}
                                   className="px-3 py-1 hover:bg-gray-100 cursor-pointer">تیکت جدید</li>
                              <li
                                   onClick={() => navigate("/ticket/ticket-list")}
                                   className="px-3 py-1 hover:bg-gray-100 cursor-pointer">لیست تیکتها</li>
                         </ul>
                    </li>
