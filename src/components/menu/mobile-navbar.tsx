  ...
  return (
    <>
      ...
      <div
        className={
          asideToggle
            ? "z-10 sm:w-1/4 absolute bg-white flex flex-col justify-end  m-1  top-0  right-0 transition-all "
            : "z-10 w-10 h-0 flex  bg-white  flex-row  justify-end transition-all "
        }
      >
        ...
        <div
          className={
            asideToggle
              ? "w-full flex flex-row-reverse justify-center  bg-gray-50 sm:bg-transparent top-0"
              : "w-0 h-0 overflow-hidden flex-col bg-gray-50 sm:bg-transparent top-0"
          }
        >
          {/* <button
            onClick={() => {
            ...
            type="button"
            className="text-black  bg-blue-400 p-2 transition-all duration-300 items-center   h-10 justify-center text-sm   rounded-lg outline-none "
          ...
          <ul className="space-y-2 font-medium w-full mx-8">
            <li className="">
              <button type="button" onClick={togglePostMenu} className=" flex flex-row justify-between items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
            ...
            <li>
              <button type="button" onClick={toggleCellarMenu} className="flex flex-row justify-between items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-blue-300 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                ...
                <span className="flex-1 ms-3 mx-4 text-right rtl:text-right whitespace-nowrap">کالا و انبار</span>
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
                  <path d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3 0 1 0 3-3H6.78l-.5-2H15Z" />
                </svg>
              </button>
