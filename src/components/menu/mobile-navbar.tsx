        ...
        >
          ...
          >
            ...
            <ul className=" font-medium w-full">
              ...
              <li>
                <a onClick={() => navigate("/dashboard")} className="cursor-pointer flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
              ...
              <li>
                <a href="#" className="flex flex-row w-1/2 items-center p-2 text-gray-900 rounded-lg group">
