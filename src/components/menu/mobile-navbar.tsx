...
export default function MobileNavbarComponent() {
  ...
  function navtigateTo(route: string) {
    navigate(route);
  ...
  return (
    <>
      {/* hambergur-button */}
      <div className={asideToggle ? "z-30  mx-auto my-auto sm:hidden  bg-black-rgba fixed inset-0" : "hidden"}>
          ...
          >
            <div className="flex flex-row justify-between ">
              <button
                ...
                type="button"
                className="sm:hidden inline-flex  transition-all duration-300 items-center  w-9 h-9 justify-center text-sm   rounded-lg outline-none "
                aria-controls="navbar-sticky"
                aria-expanded="false"
              >
                <span className="sr-only">Open main menu</span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-7 border">
                  <path fillRule="evenodd" d="M5.47 5.47a.75.75 0 0 1 1.06 0L12 10.94l5.47-5.47a.75.75 0 1 1 1.06 1.06L13.06 12l5.47 5.47a.75.75 0 1 1-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 0 1-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
                </svg>

              </button>

              {/* <img src="/imgs/brands/brand-1.jpg" className="w-20 mr-1" /> */}
            </div>
            <ul className=" font-medium w-full">

              <li>
                <a onClick={() => navtigateTo("/dashboard")} className="cursor-pointer w-fit  flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
                  ...
                  <span className="flex-1 ms-3 mx-4 whitespace-nowrap">داشبورد</span>
                </a>
              </li>


              <li>
                <a onClick={() => navtigateTo("/category/category-list")} className="cursor-pointer w-fit  flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
              ...
              <li>
                <a onClick={() => navtigateTo("/product/product-list")} className="cursor-pointer w-fit  flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 size-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
              ...
              <li>
                <a className="cursor-pointer w-fit  flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 size-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
              ...
              <li>
                <a onClick={() => navtigateTo("/faq/faq-list")} className="cursor-pointer w-fit   flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="flex-shrink-0 size-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
              ...
              <li>
                <a onClick={() => navtigateTo("/order/order-list")} className="cursor-pointer w-fit  flex flex-row items-center p-2 text-gray-900 rounded-lg  group">
              ...
              <li>
                <a href="#" className="flex flex-row w-fit   items-center p-2 text-gray-900 rounded-lg group">
