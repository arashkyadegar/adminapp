               ...
               <div className="w-full  flex flex-col sm:flex-row bg-transparent px-4">
                    <div className="w-full    justify-start   text-black z-20 flex-row  py-3">
                         <ul className=" items-center text-sm py-1 gap-4 w-full flex justify-end flex-row h-10">
                              ...
                              <li className="flex relative flex-row-reverse gap-1 justify-center items-center text-gray-500  cursor-pointer">
                                   <span onClick={() => {
                                        toggleLanguageUserDrpDwn()
                                   }}>
                                   ...
                                   {languageDrpDwnIsOpen && (
                                        <ul className="text-xs font-semibold text-gray-500 absolute top-10 -right-28 w-40 bg-gray-50 border border-gray-300">
                              ...
                              <li className="relative flex flex-row-reverse gap-1  justify-center items-center text-gray-500 cursor-pointer">
                                   <span onClick={() => { toggleUserDrpDwn() }} >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-3">
                                             <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                        </svg>
                                   </span>
                                   <img src="/imgs/people/avatar1.jpg" onClick={() => { toggleUserDrpDwn() }} className="w-9 h-9 rounded-full overflow-hidden hover:ring-2 ring-primary-green" />
                                   {userDrpDwnIsOpen && (
                                        <ul className="text-xs font-semibold text-gray-500 absolute top-10 -right-28 w-40 bg-gray-50 border border-gray-300">
