     ...
     return (
          <div className="w-full sm:w-11/12 mr-0 sm:mr-16">
               ...
               <div className=" flex flex-col p-4 bg-[#f8f9fa] ">
                    <BoxTitleLgComponent title="لیست سوالات متداول " />
                         ...
                         <div className="flex flex-col w-full bg-white  border border-gray-200">
                              <div className="flex flex-col sm:flex-row gap-2 justify-between p-4">
                                   <div className="flex flex-row gap-2 justify-end ">
                                        {/* refresh button  */}
                                        <button id="countries" onClick={() => { dispatch(getfaqsAction(1)) }} className="flex bg-gray-50 border border-gray-300 text-gray-300 items-center justify-center hover:text-gray-700 text-sm rounded-lg w-fit  p-2.5 ">
                              ...
                              <div className="relative overflow-x-auto shadow-md border border-gray-200 p-4" >
                                   <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                             {faqsState.list.map((item: any, index: number) => (
                                                  <tr
                                   ...
                                   <div className="flex flex-row-reverse justify-center gap-2 p-2">
                                        <>
                                             {(() => {
                                                  const arr = [];
                                                  for (let i = 1; i <= (Math.ceil(faqsState.totalCount / 10)); i++) {
                                                       if (i === faqsState.page) {
                                                            arr.push(
